...
<%@ include file="/include/header.jsp" %>
	...
	<div class="main flex-grow-1">  
		<div class="container my-5">
			...
			<h1 class="text-center mb-4">테스트테스트</h1>
			<%--테이블--%>
				...
				<ul class="pagination">
					...
					<c:forEach begin="${startPageNum}" end="${endPageNum}" var="i">
						<li class="page-item ${i == pageNum ? 'active' : ''}">
							<a class="page-link" href="test.jsp?pageNum=${i}${findQuery}">${i}</a>
						</li>
					</c:forEach>
					<!-- Next 버튼 -->
					<c:if test="${endPageNum < totalPageCount}">
						<li class="page-item">
							<a class="page-link" href="test.jsp?pageNum=${endPageNum + 1}${findQuery}">Next</a>
						</li>
					</c:if>
				</ul>		
			</nav>
